...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, }, "p", function () awful.spawn("firefox -new-window http://www.deezer.com") end),
    ...
    awful.key({ modkey, }, "o", function () awful.spawn("/usr/NX/bin/nxplayer") end),
...
awful.util.spawn_with_shell("sleep 1 && hsetroot -solid '#222222'")
